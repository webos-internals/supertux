...
pkglibexecdir = $(libexecdir)/supertux
...
am__aclocal_m4_deps = $(top_srcdir)/mk/autoconf/acx_pthread.m4 \
	$(top_srcdir)/mk/autoconf/ax_check_gl.m4 \
	$(top_srcdir)/mk/autoconf/sdl.m4 $(top_srcdir)/configure.ac
...
ACLOCAL = ${SHELL} /source/supertux-0.1.3/missing --run aclocal-1.11
AMTAR = ${SHELL} /source/supertux-0.1.3/missing --run tar
AUTOCONF = ${SHELL} /source/supertux-0.1.3/missing --run autoconf
AUTOHEADER = ${SHELL} /source/supertux-0.1.3/missing --run autoheader
AUTOMAKE = ${SHELL} /source/supertux-0.1.3/missing --run automake-1.11
AWK = gawk
CC = arm-none-linux-gnueabi-gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -I/opt/pre_include/SDL -D_GNU_SOURCE=1 -D_REENTRANT
CPP = arm-none-linux-gnueabi-gcc -E
CPPFLAGS = 
CXX = arm-none-linux-gnueabi-g++
CXXDEPMODE = depmode=gcc3
CXXFLAGS = -g -O2 -I/opt/pre_include/SDL -D_GNU_SOURCE=1 -D_REENTRANT -DNOOPENGL -DDATA_PREFIX='"${datarootdir}/supertux"'
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"SuperTux\" -DPACKAGE_TARNAME=\"supertux\" -DPACKAGE_VERSION=\"0.1.3\" -DPACKAGE_STRING=\"SuperTux\ 0.1.3\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"supertux\" -DVERSION=\"0.1.3\" -DHAVE_DIRENT_H=1 -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_UNISTD_H=1 -DHAVE_LIBSDL_MIXER=1 -DHAVE_LIBSDL_IMAGE=1 -DHAVE_LIBZ=1 -DHAVE_MKDIR=1 -DHAVE_STRDUP=1 -DHAVE_STRSTR=1
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lz -L$(CROSS_LIBC) -Xlinker --path-link=/opt/pre_lib -L /opt/pre_lib -lSDL_image -lSDL_mixer -lSDL
LTLIBOBJS = 
MAKEINFO = ${SHELL} /source/supertux-0.1.3/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = supertux
PACKAGE_BUGREPORT = 
...
VERSION = 0.1.3
XMKMF = 
abs_builddir = /source/supertux-0.1.3
abs_srcdir = /source/supertux-0.1.3
abs_top_builddir = /source/supertux-0.1.3
abs_top_srcdir = /source/supertux-0.1.3
ac_ct_CC = arm-none-linux-gnueabi-gcc
ac_ct_CXX = arm-none-linux-gnueabi-g++
acx_pthread_config = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /source/supertux-0.1.3/install-sh
